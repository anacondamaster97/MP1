...
public:
	...
	struct MessageHdr {
		MsgTypes msgType;
		vector<MemberListEntry> sharedList;
		Address* addr;
	};
	...
	void addMember(MemberListEntry* e);
	MemberListEntry* inMemberList(int id, short port);
	void handleMessage(Address* toaddr, MsgTypes t);
	void handlePing(MessageHdr* msg);
	MemberListEntry* inMemberList(Address* node_addr);
